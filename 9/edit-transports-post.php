...
try {
    ...
    $reqEditLine->binValue(':nom_de_ligne', $nomdeligne, PDO::PARAM_STR);
    $reqEditLine->binValue(':terminus_a', $terminusA, PDO::PARAM_STR);
    $reqEditLine->binValue(':terminus_b', $terminusB, PDO::PARAM_STR);
    $reqEditLine->binValue(':id', $id, PDO::PARAM_INT);
